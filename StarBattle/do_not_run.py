...
class Sprite:
    ...
    def draw(self, canvas):
        if self.animated:
            explosion_index = [self.age % EXPLOSION_DIM[0], EXPLOSION_DIM[1]]
...
def draw(canvas):
    global time, started, lives, score, my_ship, rock_group, rock_num, missile_group, explosion_group
    ...
    init_score = group_group_colide(missile_group, rock_group)
    if init_score > 0:
